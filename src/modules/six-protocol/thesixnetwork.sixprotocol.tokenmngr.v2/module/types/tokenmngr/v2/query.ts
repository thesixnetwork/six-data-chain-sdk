...
import { Params } from "../../tokenmngr/v2/params";
import { Token } from "../../tokenmngr/v2/token";
import {
  PageRequest,
  PageResponse,
} from "../../cosmos/base/query/v1beta1/pagination";
import { Mintperm } from "../../tokenmngr/v2/mintperm";
import { Options } from "../../tokenmngr/v2/options";
import { Burn } from "../../tokenmngr/v2/burn";
import { TokenBurn } from "../../tokenmngr/v2/token_burn";

export const protobufPackage = "thesixnetwork.sixprotocol.tokenmngr.v2";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "thesixnetwork.sixprotocol.tokenmngr.v2.Query",
      "Params",
      data
    );
