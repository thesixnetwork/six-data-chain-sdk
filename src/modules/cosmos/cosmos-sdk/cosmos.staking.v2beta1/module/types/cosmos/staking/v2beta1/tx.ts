...
const baseMsgWhitelistDelegatorResponse: object = {};

export const MsgWhitelistDelegatorResponse = {
  encode(
    message: MsgWhitelistDelegatorResponse,
    writer: Writer = Writer.create()
  ): Writer {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgWhitelistDelegatorResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgWhitelistDelegatorResponse,
    } as MsgWhitelistDelegatorResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgWhitelistDelegatorResponse {
    const message = {
      ...baseMsgWhitelistDelegatorResponse,
    } as MsgWhitelistDelegatorResponse;
    if (
  ...
  toJSON(message: MsgWhitelistDelegatorResponse): unknown {
    const obj: any = {};
    message.whitelist_delegator !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<MsgWhitelistDelegatorResponse>
  ): MsgWhitelistDelegatorResponse {
    const message = {
      ...baseMsgWhitelistDelegatorResponse,
    } as MsgWhitelistDelegatorResponse;
...
export interface Msg {
  ...
  ): Promise<MsgWhitelistDelegatorResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  CreateWhitelistdelegator(
    ...
    return promise.then((data) =>
      MsgWhitelistDelegatorResponse.decode(new Reader(data))
    );
  }
