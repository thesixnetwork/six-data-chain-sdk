...
import {
  ...
  Pool,
  Params,
} from "../../../cosmos/staking/v2beta1/staking";
import {
  PageRequest,
  PageResponse,
} from "../../../cosmos/base/query/v1beta1/pagination";
import { WhitelistDelegator } from "../../../cosmos/staking/v2beta1/whitelist";
...
const baseQueryGetWhitelistDelegatorResponse: object = {};

export const QueryGetWhitelistDelegatorResponse = {
  encode(
    message: QueryGetWhitelistDelegatorResponse,
    writer: Writer = Writer.create()
  ): Writer {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetWhitelistDelegatorResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetWhitelistDelegatorResponse,
    } as QueryGetWhitelistDelegatorResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetWhitelistDelegatorResponse {
    const message = {
      ...baseQueryGetWhitelistDelegatorResponse,
    } as QueryGetWhitelistDelegatorResponse;
    if (
  ...
  toJSON(message: QueryGetWhitelistDelegatorResponse): unknown {
    const obj: any = {};
    message.whitelist_delegator !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<QueryGetWhitelistDelegatorResponse>
  ): QueryGetWhitelistDelegatorResponse {
    const message = {
      ...baseQueryGetWhitelistDelegatorResponse,
    } as QueryGetWhitelistDelegatorResponse;
...
const baseQueryAllWhitelistdelegatorResponse: object = {};

export const QueryAllWhitelistdelegatorResponse = {
  encode(
    message: QueryAllWhitelistdelegatorResponse,
    writer: Writer = Writer.create()
  ): Writer {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllWhitelistdelegatorResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllWhitelistdelegatorResponse,
    } as QueryAllWhitelistdelegatorResponse;
    message.whitelist_delegator = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): QueryAllWhitelistdelegatorResponse {
    const message = {
      ...baseQueryAllWhitelistdelegatorResponse,
    } as QueryAllWhitelistdelegatorResponse;
    message.whitelist_delegator = [];
  ...
  toJSON(message: QueryAllWhitelistdelegatorResponse): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<QueryAllWhitelistdelegatorResponse>
  ): QueryAllWhitelistdelegatorResponse {
    const message = {
      ...baseQueryAllWhitelistdelegatorResponse,
    } as QueryAllWhitelistdelegatorResponse;
...
export interface Query {
  ...
  ): Promise<QueryGetWhitelistDelegatorResponse>;
...
export class QueryClientImpl implements Query {
  ...
  Whitelistdelegator(
    ...
    return promise.then((data) =>
      QueryGetWhitelistDelegatorResponse.decode(new Reader(data))
    );
  }
  ...
  WhitelistdelegatorAll(
    ...
    return promise.then((data) =>
      QueryAllWhitelistdelegatorResponse.decode(new Reader(data))
    );
  }
}
