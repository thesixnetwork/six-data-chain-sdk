...
export interface ActionParamV063 {
  nft_schema_code: string;
  token_id: string;
  action: string;
  ref_id: string;
...
export interface ActionRequestV063 {
  id: number;
  nft_schema_code: string;
  token_id: string;
  action: string;
...
const baseActionParamV063: object = {
  nft_schema_code: "",
  token_id: "",
  action: "",
  ref_id: "",
...
export const ActionParamV063 = {
  encode(message: ActionParamV063, writer: Writer = Writer.create()): Writer {
    if (message.nft_schema_code !== "") {
      writer.uint32(10).string(message.nft_schema_code);
    }
    if (message.token_id !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): ActionParamV063 {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseActionParamV063 } as ActionParamV063;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ActionParamV063 {
    const message = { ...baseActionParamV063 } as ActionParamV063;
    if (
      object.nft_schema_code !== undefined &&
      object.nft_schema_code !== null
  ...
  toJSON(message: ActionParamV063): unknown {
    const obj: any = {};
    message.nft_schema_code !== undefined &&
      (obj.nft_schema_code = message.nft_schema_code);
    message.token_id !== undefined && (obj.token_id = message.token_id);
  ...
  fromPartial(object: DeepPartial<ActionParamV063>): ActionParamV063 {
    const message = { ...baseActionParamV063 } as ActionParamV063;
    if (
      object.nft_schema_code !== undefined &&
      object.nft_schema_code !== null
...
const baseActionRequestV063: object = {
  id: 0,
  nft_schema_code: "",
  token_id: "",
  action: "",
...
export const ActionRequestV063 = {
  encode(message: ActionRequestV063, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.nft_schema_code !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): ActionRequestV063 {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseActionRequestV063 } as ActionRequestV063;
    message.confirmers = [];
    message.data_hashes = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
  ...
  fromJSON(object: any): ActionRequestV063 {
    const message = { ...baseActionRequestV063 } as ActionRequestV063;
    message.confirmers = [];
    message.data_hashes = [];
    if (object.id !== undefined && object.id !== null) {
  ...
  toJSON(message: ActionRequestV063): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = message.id);
    message.nft_schema_code !== undefined &&
      (obj.nft_schema_code = message.nft_schema_code);
  ...
  fromPartial(object: DeepPartial<ActionRequestV063>): ActionRequestV063 {
    const message = { ...baseActionRequestV063 } as ActionRequestV063;
    message.confirmers = [];
    message.data_hashes = [];
    if (object.id !== undefined && object.id !== null) {
