...
export const ActionV063 = {
  encode(message: ActionV063, writer: Writer = Writer.create()): Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.desc !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): ActionV063 {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseActionV063 } as ActionV063;
    message.then = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): ActionV063 {
    const message = { ...baseActionV063 } as ActionV063;
    message.then = [];
    if (object.name !== undefined && object.name !== null) {
      message.name = String(object.name);
  ...
  toJSON(message: ActionV063): unknown {
    const obj: any = {};
    message.name !== undefined && (obj.name = message.name);
    message.desc !== undefined && (obj.desc = message.desc);
    message.disable !== undefined && (obj.disable = message.disable);
  ...
  fromPartial(object: DeepPartial<ActionV063>): ActionV063 {
    const message = { ...baseActionV063 } as ActionV063;
    message.then = [];
    if (object.name !== undefined && object.name !== null) {
      message.name = object.name;
